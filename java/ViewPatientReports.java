                ...
                if (patient.next()) {
                    ...
                    try (ResultSet rsBloodPressure = dbHandler.getBloodPressureReports(patientId)) {
                        while (rsBloodPressure.next()) {
                            int bloodPressureTest1 = rsBloodPressure.getInt("BloodPresureTest1");
                            int bloodPressureTest2 = rsBloodPressure.getInt("BloodPresureTest2");
                            int bloodPressureTest3 = rsBloodPressure.getInt("BloodPresureTest3");
